package hdisoft.app.webserver.internal
...
/**
 * Vendored from hdisoft.app.core.utils.AppTool.openApp so :libs:webserver has zero
 * cross-module dependencies and can be built/published standalone from its own repo.
 */
